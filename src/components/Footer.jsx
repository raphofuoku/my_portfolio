  ...
  return (
    <footer className="footer--container">
      ...
      <div className="footer--content--container">
        <p className="footer--content">Created By Raphael Ofuoku</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/ofuoku.raphael"
            ...
            <li>
              <a
                href="https://www.instagram.com/justraph007"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.x.com/JustRaph007"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/raphaelofuoku/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
