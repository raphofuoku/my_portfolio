  ...
  return (
    <section className="portfolio--section" id="Portfolio">
      <div className="portfolio--container-box">
        ...
        <div>
          <a href="https://github.com/raphofuoku" target="_blank" rel="noopener noreferrer" className="github--a">
            ...
            <div className="portfolio--section--card--content">
              ...
              <div className="portfolio--links">
                 <p className="text-sm portfolio--link">
                   <a href={item.link} target="_blank" rel="noopener noreferrer" className="github--a">
                    Github
                   </a>
                 </p>
                 <p className="text-sm portfolio--live">
                   <a href={item.live} target="_blank" rel="noopener noreferrer" className="github--a">
                     Live
                   </a>
                 </p>
              </div>
